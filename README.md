...
- **Кадрирование**:  Если нужна поддержка телефонов или поддержка больших страниц, логично сразу заскейлить все страницы под viewport, чтобы страницы отображались целиком.  
  Пока фикс закомментирован. Решение связано с вычислением squareFactor и ResizeObserverService для viewport.
...
- Поддержка текстового слоя.
  > 💡 **Решение**: Грузить текстовый слой и слой аннотаций отдельно для каждой страницы.

- Добавить поддержку мобильных устройств.

  > 💡 **Решение**: Доработать кадрирование, чтобы страницы по умолчанию помещались в экран, Оптимизировать все компоненты (диалоги, кнопки, меню) для удобной работы на сенсорных экранах.`.
- Отсутствие тестов.

  > 💡 **Решение**: До дедлайна было ещё два дня. Добавить тесты. Удалить Karma и попробовать как angular внедрил vitest [experimental-unit-test](https://github.com/angular/angular/blob/main/adev/src/content/guide/testing/experimental-unit-test.md)